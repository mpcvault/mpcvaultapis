...
CALLBACK_CLIENT_SIGNER_PUBLIC_KEY = "[callback client signer public key]"
...
if __name__ == '__main__':
    ...
    gas_fee = pb.EVMGas(
        gas_limit=StringValue(value="10000000"))  # you can leave other fields empty to use default gas settings
    ...
    response = stub.CreateSigningRequest(pb.CreateSigningRequestRequest(evm_send_custom=pb.EVMSendCustom(**{
        ...
        "nonce": StringValue(value="0"),  # you can leave this empty to use default nonce
    })))
